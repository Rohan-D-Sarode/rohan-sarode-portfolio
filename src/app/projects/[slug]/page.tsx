...
import React from "react"; // Add this import so that the JSX namespace is available
...
// In Next.js 15.2, dynamic route props are provided as promises.
export default async function ProjectPage({
  ...
  // Await searchParams even if we don't use it
